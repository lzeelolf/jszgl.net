...
($ => {
    ...
    LOCALES['en-US'] = LOCALES.en = {
        ...
        formatShowingRows(pageFrom, pageTo, totalRows) {
            return Utils.sprintf('目前显示 第%s条 ~ 第%s条 共 %s 条', pageFrom, pageTo, totalRows)
        },
        formatDetailPagination(totalRows) {
            return Utils.sprintf('目前显示 %s 条', totalRows)
        },
        formatSearch() {
            return 'Search'
        },
        ...
        initToolbar() {
            ...
            if (this.options.search) {
                ...
                html.push(
                    ...
                    Utils.sprintf(`<input class="form-control${Utils.sprintf(' input-%s', this.options.iconSize)}" type="text" placeholder="搜索">`,
